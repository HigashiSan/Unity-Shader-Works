...
public class SSAOControl : MonoBehaviour
{
    ...
    private List<Vector4> SampleVectorArrays = new List<Vector4>();
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        SSAOMat.SetVectorArray("_SampleArray", SampleVectorArrays.ToArray());
        SSAOMat.SetFloat("_SampleTimes", SampleVectorArrays.Count);
    ...
    {
        if (SampleTimes == SampleVectorArrays.Count)
            return;
        SampleVectorArrays.Clear();
